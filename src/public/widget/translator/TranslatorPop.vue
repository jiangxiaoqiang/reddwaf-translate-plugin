<template>
  <div id="reddwarf-translate-app" dir="ltr" class="bp3-focus-disabled">
    <div id="app">
      <div id="translate-btn" style="">
        <button
          type="button"
          class="bp3-button btn-icon"
          @click="safeTranslate"
        ></button>
      </div>
      <div
            ...
            <div class="bp3-collapse">
              ...
              <div class="bp3-collapse-body" aria-hidden="true">
                <div class="bp3-card bp3-elevation-0 quick-settings">
                  <div>
                      ...
                      ><span aria-haspopup="true" class="bp3-popover-target">
                        <div class="">
                          <button type="button" class="bp3-button bp3-small">
                            <span class="bp3-button-text">自动检测</span
                            ><span
                              icon="caret-down"
                              aria-hidden="true"
                    ...
                    ><span class="bp3-popover-wrapper lang-select"
                      ><span aria-haspopup="true" class="bp3-popover-target">
                        <div class="">
                          <button type="button" class="bp3-button bp3-small">
                            <span class="bp3-button-text">中文(简体)</span
                            ><span
                              icon="caret-down"
                              aria-hidden="true"
                              class="bp3-icon bp3-icon-caret-down"
                  ...
                  <div>
                    ...
                    ><span class="bp3-popover-wrapper"
                      ><span aria-haspopup="true" class="bp3-popover-target"
                        ><label
                          class="
                            bp3-control bp3-checkbox bp3-disabled bp3-inline
                          "
                          ><input
                            disabled=""
                            tabindex="0"
                  ...
                  <div>
                    <label class="bp3-control bp3-radio bp3-inline"
                      ><input
                        ...
                        value="small"
                        checked=""
                      /><span class="bp3-control-indicator"></span>小</label
                    ><label class="bp3-control bp3-radio bp3-inline"
                      ><input
                        name="Blueprint3.RadioGroup-0"
                        type="radio"
                        value="middle"
                      /><span class="bp3-control-indicator"></span>中</label
                    ><label class="bp3-control bp3-radio bp3-inline"
                      ><input
                        name="Blueprint3.RadioGroup-0"
                        type="radio"
                        value="large"
                      /><span class="bp3-control-indicator"></span>大</label
                    >
                  </div>
                  <div>
                    <label class="bp3-control bp3-checkbox bp3-inline"
                      ...
                      >显示文本框</label
                    ><label
                      class="bp3-control bp3-checkbox bp3-inline"
                  ...
                  <a class="bp3-text-small">打开完整设置</a
                  ><a class="bp3-text-small" style="margin-left: 15px"
                    ><span
                      icon="crown"
                      aria-hidden="true"
                      class="bp3-icon bp3-icon-crown"
                      ...
                      >
                        <path
                          d="M2 6l3 2 3-4 3 4 3-2-1 6H3L2 6zm6-5a1 1 0 110 2 1 1 0 010-2zM1 3a1 1 0 110 2 1 1 0 010-2zm14 0a1 1 0 110 2 1 1 0 010-2zM3 13h10v2H3v-2z"
                          fill-rule="evenodd"
                        ></path></svg
                    ></span>
                    开通会员</a
...
#translate-panel.size-small h6.bp3-heading,
#translate-panel.size-small .bp3-control.bp3-large,
#translate-panel.size-small textarea.bp3-input.bp3-small {
  font-size: 14px;
}
...
#translate-panel.size-middle h6.bp3-heading,
#translate-panel.size-middle .bp3-control.bp3-large,
#translate-panel.size-middle textarea.bp3-input {
  font-size: 18px;
}
...
#translate-panel.size-large h6.bp3-heading,
#translate-panel.size-large .bp3-control.bp3-large,
#translate-panel.size-large textarea.bp3-input.bp3-large {
  font-size: 22px;
}
...
#translate-panel .bp3-button.bp3-small,
#translate-panel .bp3-small .bp3-button {
  min-height: 20px;
  min-width: 20px;
}
...
#translate-panel .header .right .bp3-icon-arrow-right {
  flex-shrink: 0;
  margin: 0 5px;
}

#translate-panel .header .right > .bp3-button {
  flex-shrink: 0;
  margin: 0 1px;
}

#translate-panel .header .right > .bp3-button:last-child {
  margin-right: 0;
}
...
#translate-panel .quick-settings .bp3-control {
  margin-bottom: 0;
}
...
#translate-panel .query-text textarea.bp3-input {
  min-height: 44px;
...
.result-block .bp3-button {
}

.result-block .error .bp3-button,
.result-block:hover .bp3-button {
  visibility: visible;
}
...
.result-block .legend .bp3-heading {
  flex-shrink: 0;
  white-space: nowrap;
}
...
.result-block .legend .source .bp3-icon {
  position: relative;
  top: -1px;
  margin-left: 1px;
}
...
.bp3-dark #popper-container .arrow::before {
  background-color: #293742;
}
...
#popper-container.show[data-popper-placement]:not([data-popper-reference-hidden="true"])
  .arrow {
  display: block;
}
...
.translate-type-selector .bp3-label {
  display: inline;
}

.translate-type-selector .bp3-radio {
  margin-bottom: 0;
}
...
.switch-pin .bp3-icon-pin {
  transition: transform 0.2s, color 0.2s;
  transform: rotate(-45deg);
}

.pin .switch-pin .bp3-icon-pin {
